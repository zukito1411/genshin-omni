...
export interface CharacterImageFiles {
  icon?: string;
  iconCard?: string;
  sideIcon?: string;
  gachaSplash?: string;
...
export interface LibraryEntity { id:string; name:string; rarity?:number; type?:string; description?:string; icon:string; baseAttack?:number; secondaryStat?:string; secondaryValue?:string; effectName?:string; twoPieceBonus?:string; fourPieceBonus?:string; raw:Record<string,unknown>; }
