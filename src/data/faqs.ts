...
export const faqs: FAQItem[] = [
  ...
  { question: 'Why does a material quantity sometimes show “—”?', answer: 'The app refuses to invent quantities when the upstream character payload does not expose a numeric amount in the schema. The raw provider response remains available for inspection.', tags: ['materials', 'accuracy'] },
  { question: 'Can I deploy this without a backend?', answer: 'Yes. The app is a Vite React SPA. Netlify or Render can host the static build while the browser requests the public APIs directly. Availability still depends on the provider allowing browser requests.', tags: ['deploy', 'netlify', 'render'] },
];
